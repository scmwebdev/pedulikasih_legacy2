...
class CI_Sctvcache {
	...
	protected $memcached = array(
										        ...
										        'config' => array(
														    'prefix'                 => 'sctv:',       // Prefixes every key value (useful for multi environment setups)
														    ...
														    'expiration'             => 0,          // Default content expiration value (in seconds) if not expire = 0
