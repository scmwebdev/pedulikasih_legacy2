...
Ext.onReady(function () {
    ...
    function settplvidPictureSearch(yid) {
        tplvidPictureSearch = '<p align="center"><img width="' + Ext.getCmp('previdPictureSearch').getWidth() + '" src="<?=STATIC_URL?>images/kitapeduli/gallery/' + yid + '"></p>';
    }
    ...
    function uploadImage(id_album, judul_album) {
        ...
        var viewPictureSearch = Ext.create('Ext.view.View', {
            ...
            tpl: [
                    ...
                    '<div class="thumb"><img src="<?=STATIC_URL?>images/kitapeduli/gallery/th_{image}" title="{keterangan}"></div>',
    ...
    var gridData = Ext.create('Ext.grid.Panel', {
        store: storeData,
        width: '100%',
        title: 'Kita Peduli Photo Gallery Management',
        region: 'center',
        columnLines: true,
                ...
                items: [
                    {
                        ...
                        handler: function (grid, rowIndex, colIndex) {
                            ...
                            var uri = 'http://www.indosiar.com/kitapeduli/gallery/' + rec.get("judul_url");
                            window.open(uri);
                        }
                    }, 
                    <?php if (isset($modAuths['add']) || isset($modAuths['edit'])): ?> 
