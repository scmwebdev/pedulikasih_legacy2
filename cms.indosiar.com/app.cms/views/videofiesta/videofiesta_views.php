...
Ext.onReady(function(){	
		...
		Ext.define("modelForm", {
		    ...
		    fields: ['v_id','filenameimage_old','filenamelogo_old','id','judul','tanggal','keterangan','id_kategori','kategori','filenameimage','filenamelogo','videoall','file_flv','file_flv2','file_flv3','file_flv4','file_flv5','file_flv6','image','logo','link','status_variety','status_program','publish','start','limit','page'],
		    sortInfo: {field: 'id', direction: "DESC"}
		});

		Ext.define("modelFormcategory", {
		    extend: "Ext.data.Model",
		    fields: ['id','kategori','id_kategori','limit','page'],
		    sortInfo: {field: 'id', direction: "DESC"}
		});
		...
		var combo_category = Ext.create("Ext.data.Store", {
		    model: "modelFormcategory",
		    autoLoad: true,
		    pageSize: itemsPerPage,
		    proxy: {
		        type: "ajax",		        
		       	url: mod_url+'&m=jsoncategory',
		        simpleSortMode: true,
		        reader: {
		            type: "json",
		            root: "rows",
	  ...
	  function addData() {    
	  		sessChecked();
	  		<?=$this->videofiesta_model->formeditor('formInputAdd','formeditoraddid')?> 
	  ...
	  function editData() {		
	  		sessChecked();
	  		<?=$this->videofiesta_model->formeditor('formInputEdit','formeditoreditid')?>   	
		...
		var gridData = Ext.create('Ext.grid.Panel', {
	      ...
	      height: '100%',	
		    ...
		    columns: [	    
		    	...
		    	{text:'Tanggal', dataIndex:'tanggal',align:'center', width:100},
		    	{text:'Keterangan', dataIndex:'keterangan',align:'center', width:200},
		    	{text:'Video', dataIndex:'videoall',align:'center', width:300},
		    	{text:'Image Video FLV', dataIndex:'image',align:'center', width:200},
		    	{text:'logo Video FLV', dataIndex:'logo',align:'center', width:200},
