...
Ext.onReady(function(){
	...
	Ext.define('modelData', {
	    ...
	    fields: ['id','image','pdf','tahun','publish']
	});
	...
	var gridData = Ext.create('Ext.grid.Panel', {
	    store: storeData,
	    width: '100%',
	    title: 'Annual Report Management',
	    region: 'center',
	    columnLines: true,
	      selModel: Ext.create('Ext.selection.CheckboxModel', {
		    ...
		    listeners : {
				...
				<?php endif;?>
		    columns: [    
                    {text:'Tahun', dataIndex:'tahun', sortable: false, width:100, align:'center'},
					    ...
					    items: [
                            {
    		                    ...
    		                    handler: function(grid, rowIndex, colIndex) {
    		                        ...
    		                        if (rec.get("pdf") != "") window.open('<?=STATIC_URL?>pdf/investor/annualreport/'+rec.get("pdf"));
    		                    }
				          	}
			          	]		          	
                },{
    	    		...
    	    		items: [
                        {
    		                ...
    		                handler: function(grid, rowIndex, colIndex) {
    		                    var rec = gridData.getStore().getAt(rowIndex);
    		                    if (rec.get("image") != "") window.open('<?=STATIC_URL?>images/investor/annualreport/'+rec.get("image"));
                            }
    				    }
                    ]
                },{
        ...
        items: [
            {
                ...
                xtype:'hidden',name:'pdf'
            },{
                xtype: 'fileuploadfield',
                fieldLabel: 'Cover Image',
                name: 'image_file',
                emptyText: 'upload cover image',
                buttonText: 'Browse'
            },{
                xtype: 'fileuploadfield',
                fieldLabel: 'PDF File',
                name: 'pdf_file',
                emptyText: 'upload pdf file',
                buttonText: 'Browse'
