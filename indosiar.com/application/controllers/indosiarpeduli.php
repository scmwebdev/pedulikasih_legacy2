<?php
class indosiarpeduli extends CI_Controller {
	var $data = array();
	...
	function index(){
	    $this->load->view('indosiarpeduli/indosiarpeduli');
    }
	...
	function _content($kategori) {
		...
		if ($this->uri->segment(3) == "" && $kategori != 'audit') {
		...
		} elseif ($this->uri->segment(3) == "page" || $kategori == 'audit') {
