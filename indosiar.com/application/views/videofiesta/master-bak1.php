...
<?
$rec=1;
$sql="select tblv.*,tblk.kategori from tbl_video as tblv inner join tbl_video_kategori as tblk on tblv.id_kategori=tblk.id and tblv.id_kategori<>11 and ".$sql_not1." order by tblv.id desc limit 0,12";
$query = $this->db->query($sql);
if ($query->num_rows() > 0) {
?>
	<div id="screen" >
