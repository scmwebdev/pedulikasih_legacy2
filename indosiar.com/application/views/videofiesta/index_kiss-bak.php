					        ...
					        <tr>
					          <td width="28%">
					            <table border="0" cellspacing="0" cellpadding="0">
					              ...
					              <tr>
					                <td bgcolor="#8E8E8E"><img src="<?=URL_VIDEO_IMG?>blnk.gif" width="5" height="5" /></td>
					                <td align="center"><a href="<?=URL_VIDEO?>kiss/<?=$page?>/<?=$row->id?>/<?=judul2url(htmlentities($row->judul))?>"><img src="http://www.indosiar.com/images/videofiesta/<?=$row->image?>" width="139" height="65" border="0" /></a></td>
					                <td bgcolor="#8E8E8E"><img src="<?=URL_VIDEO_IMG?>blnk.gif" width="5" height="5" /></td>
					              </tr>
								  <tr>
					                <td><img src="<?=URL_VIDEO_IMG?>v-frame_07.jpg" width="11" height="8" /></td>
